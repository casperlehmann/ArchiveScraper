...
class TestDearchiver(object):
    ...
    def test__save_url_to_fname(self):
        self.dearch._save_url_to_fname('www.example.com', '000001')
        assert_equals(
            json.load(open(self.dearch.json_file)),
            {'www.example.com': {'f': '000001'}})

    def test__save_url_to_fname_url_raises_TypeError(self):
        assert_raises(
            TypeError, self.dearch._save_url_to_fname,
            url = 1, fname = '000001')

    def test__save_url_to_fname_fname_raises_TypeError(self):
        assert_raises(
            TypeError, self.dearch._save_url_to_fname,
    ...
    def test__get_filename(self):
        ...
        with open(fpath, 'wb') as f: f.write(b'Some contents')
        self.dearch._save_url_to_fname('www.example.com', fname)
...
class TestArticleGetter(object):
    ...
    def test__save_url_to_fname(self):
        self.artget._save_url_to_fname('www.example.com', '000001')
        assert_equals(
    ...
    def test__save_url_to_fname_url_raises_TypeError(self):
        assert_raises(
            TypeError, self.artget._save_url_to_fname,
            url = 1, fname = '000001')
    ...
    def test__save_url_to_fname_and_links(self):
